...
export const HERO_CAPTURES: readonly [ProductCapture, ProductCapture] = [
  ...
  capture({
    ...
    title: 'Now Playing',
    platform: 'Android',
    description: 'The scene responds to any track in real time, using the same engine as the app.',
    alt: 'Reprise on Android showing the animated audio-reactive Now Playing scene',
