    ...
    <footer className="site-footer" data-ground="oklch(10.5% 0.012 269)">
      <div className="site-footer__frame">
        ...
        <p className="site-footer__honesty" data-reveal>
          ...
          <strong>Counted:</strong> the line volumes, their shares, the gate count and the five
          weeks are read out of this repository while the page is built —{' '}
          ...
          recounts both describe things that happened once and cannot be recounted from the tree,
          so they are read from{' '}
          ...
          , where every row and every claim carries its commit, its date and its method. <strong>Stated:</strong>{' '}
