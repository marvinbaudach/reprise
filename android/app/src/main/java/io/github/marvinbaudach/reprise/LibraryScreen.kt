...
internal fun LibraryScreen(
    ...
    openArtist: suspend (LibraryArtist) -> ArtistTrackList,
    listArtistTracks:
    ...
    when (val current = state) {
        ...
        is LibraryScreenState.Browse -> BrowseScreen(
            ...
            searchTitles = offMainLibraryRead(searchTitles),
            listArtists = offMainLibraryRead(listArtists),
            searchArtists = offMainLibraryRead(searchArtists),
            openAlbum = offMainLibraryRead(openAlbum),
            listAlbumTracks = offMainLibraryRead(listAlbumTracks),
            openArtist = offMainLibraryRead(openArtist),
            listArtistTracks = offMainLibraryRead(listArtistTracks),
            listArtistAlbums = offMainLibraryRead(listArtistAlbums),
            listArtistUntaggedTracks = offMainLibraryRead(listArtistUntaggedTracks),
            loadTrack = loadTrack,
