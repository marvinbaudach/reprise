...
def stats_symbolic_svg():
    return '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
     width="24" height="24" fill="currentColor">
  <!-- Palette-independent symbolic geometry generated by the brand pipeline. -->
  <rect x="3" y="2" width="2" height="19" rx="1"/>
  <rect x="3" y="19" width="19" height="2" rx="1"/>
  <path d="M8.247 16.664 12.247 12.164 10.753 10.836 6.753 15.336Z"/>
  <path d="M10.896 12.297 14.196 14.797 15.404 13.203 12.104 10.703Z"/>
  <path d="M15.611 14.586 20.811 7.386 19.189 6.214 13.989 13.414Z"/>
  <circle cx="7.5" cy="16" r="1"/>
  <circle cx="11.5" cy="11.5" r="1"/>
  <circle cx="14.8" cy="14" r="1"/>
  <circle cx="20" cy="6.8" r="1"/>
</svg>
'''
