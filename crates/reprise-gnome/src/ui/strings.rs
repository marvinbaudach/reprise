...
pub const ONBOARDING_NO_LIBRARY_YET_IN: &str = N_!("Reprise has no library yet · {folder}");
...
pub const PRESET_CLASSICAL: &str = N_!("Classical");
pub const PRESET_JAZZ: &str = N_!("Jazz");
pub const PRESET_ELECTRONIC: &str = N_!("Electronic");
pub const PRESET_VOCAL: &str = N_!("Vocal & Podcast");
pub const PRESET_HEADPHONES: &str = N_!("Headphones");
pub const PRESET_LATE_NIGHT: &str = N_!("Late Night");
pub const PRESET_CUSTOM: &str = N_!("Custom");
pub const EQUALIZER_MANUAL: &str = N_!("Adjust bands manually");
