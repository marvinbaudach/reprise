...
mod tests {
    ...
    #[test]
    fn player_bar_shell_root_is_a_structural_box() {
        let _: fn(&LibraryPlayerBarShell) -> &gtk4::Box = LibraryPlayerBarShell::widget;
    }
    ...
    fn play_7b_player_bar_is_a_structural_edge_at_bottom_and_top() {
