...
pub(super) struct ThemeTokens {
    ...
    pub(super) mini_card_bg: &'static str,
...
impl ThemeTokens {
    pub(super) fn for_appearance(is_dark: bool) -> Self {
        ...
        Self {
            ...
            mini_card_bg: select(t::MINI_CARD_BG_DARK, t::MINI_CARD_BG_LIGHT),
            mini_card_edge: select(t::MINI_CARD_EDGE_DARK, t::MINI_CARD_EDGE_LIGHT),
            mini_cover_edge: select(t::MINI_COVER_EDGE_DARK, t::MINI_COVER_EDGE_LIGHT),
