...
pub(in crate::ui) const SYNCED_TAGS: &str = N_!("synced · tags");
pub(in crate::ui) const SYNCED_SIDECAR: &str = N_!("synced · .lrc");
pub(in crate::ui) const LYRICS_SIDECAR: &str = N_!("lyrics · .lrc");
pub(in crate::ui) const SYNCED_LRCLIB: &str = N_!("synced · LRCLIB");
pub(in crate::ui) const LYRICS_LRCLIB: &str = N_!("lyrics · LRCLIB");
pub(in crate::ui) const SYNCED_NETEASE: &str = N_!("synced · NetEase");
pub(in crate::ui) const LYRICS_NETEASE: &str = N_!("lyrics · NetEase");
