...
use crate::ui::style::tokens::{
    NOW_PLAYING_FOOTER_SIZE, NOW_PLAYING_PILL_BG_ALPHA, NOW_PLAYING_PILL_RADIUS,
    NOW_PLAYING_SUBTITLE_SIZE, NOW_PLAYING_TITLE_SIZE, RADIUS_SURFACE,
};
...
pub(super) fn css() -> String {
    format!(
     ...
     .reprise-now-playing-cover {{ \
       ...
       box-shadow: inset 0 0 0 1px @reprise_cover_edge, \
                   0 2px 6px @reprise_cover_shadow; }}\n\
