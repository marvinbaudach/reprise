...
use gtk4::gio;
// Not `gtk4::prelude` as well: libadwaita re-exports it, and the newer rustc
// the CI runner installs at job time reports the second import as unused while
// the one on this machine does not.
