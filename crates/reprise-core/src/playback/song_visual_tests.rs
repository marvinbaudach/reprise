...
#[test]
fn ac_22_cava_bars_cross_the_frame_boundary_without_remapping() {
...
#[test]
fn ac_22_cava_frame_boundary_neutralizes_hostile_values() {
...
#[test]
fn ac_22_coalescing_keeps_only_the_latest_cava_frame() {
