...
mod tests {
    ...
    #[test]
    fn mtp_50_content_row_reads_the_targets_per_device_folder_activation_and_cap() {
    ...
    #[test]
    fn mtp_50_a_disabled_target_reads_source_off_even_with_a_nonzero_diff() {
        let target = SyncTarget {
    ...
    #[test]
    fn mtp_50_an_enabled_target_reads_its_computed_diff() {
        let target = SyncTarget {
